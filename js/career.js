career = [{
    key: 1,
    startDate: new Date(Date.UTC(2015, 6)),
    endDate: new Date(Date.UTC(2016, 1)),
    role: "Intern",
    company: "International Business Machines (IBM)",
    description: `A series of training sessions that furthered my knowledge in
      Web Development, Java, J2EE, MVC frameworks, Spring, Struts, JSF, JSP,
      SQLite, MySQL. Even testing methodologies.`,
    technologies: `Web Development, Eclipse, Java, J2EE, MVC, Database,
      Testing Concepts`,
    location: "Cebu City, Cebu, Philippines"
  },
  {
    key: 2,
    startDate: new Date(Date.UTC(2016, 3)),
    endDate: new Date(Date.UTC(2018, 4)),
    ...
    description: `Printers and MFPs driver engineer for Linux, Mac, and
      ...
      release, and finally end-user technical support.
      <br>
      Later, a GUI application was added to Linux driver written in C/C++ and
      Qt framework. The accompanying back-end filters, which inject the print
